...
export const dummyPackages: Package[] = [
  // DATA DUMMY: Paket 1 — Umroh Reguler Plus Thaif 10 Hari (Paket Utama Detail Fase 4)
  {
    ...
    hotelMakkah: "Hotel pilihan — Bintang 4",
    hotelMadinah: "Hotel pilihan — Bintang 4",
    hotelMakkahDetail: "Hotel bintang 4 pilihan, dengan prioritas akses mudah menuju Masjidil Haram.",
    hotelMadinahDetail: "Hotel bintang 4 pilihan, dengan akses nyaman menuju Masjid Nabawi.",
    rating: 4.9,
    reviewCount: 87,
    isUmroh: true,
    isHaji: false,
  ...
  // DATA DUMMY: Paket 2 (Umroh Plus Dubai 12 Hari)
  {
    ...
    hotelMakkah: "Hotel pilihan — Bintang 5",
    hotelMadinah: "Hotel pilihan — Bintang 5",
    rating: 4.8,
    reviewCount: 54,
    isUmroh: true,
    isHaji: false,
